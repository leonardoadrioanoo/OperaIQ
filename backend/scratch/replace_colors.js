const fs = require('fs');
const path = 'c:\\OperaIQ\\frontend\\src\\app\\dashboard\\portfolio\\[id]\\page.tsx';
...
// Form outlines
content = content.replace(/border-border\/60 rounded-md/g, 'border-border rounded-md'); // cleanup if needed
