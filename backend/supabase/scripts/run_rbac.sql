...
-- Cria a estrutura dinâmica do RBAC
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM public.sys_modulos WHERE nome = 'Início') THEN
    ...
    (p_admin_org, m_administracao, true, true, true, false, false);
    ...
    -- Atualiza os perfis atuais para apontar para os IDs criados
