...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-[#07070f] text-white">
      {/* NAVBAR */}
      ...
      <main className="flex-1">
        {/* HERO SECTION */}
        <section className="pt-40 pb-28 bg-gradient-to-br from-[#020718] via-[#06143a] to-[#08194f] text-white text-center relative overflow-hidden">
          <div className="absolute inset-0 opacity-16 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at center, rgba(255,255,255,0.08) 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
          <div className="container relative z-10 mx-auto px-6 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/login">
                <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-slate-800/70 bg-transparent w-full sm:w-auto">
                  Evolua sem limites
                </Button>
              </Link>
            </div>
        ...
        <section className="py-24 bg-[#07070f]">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-bold tracking-tight mb-4 text-white">Uma plataforma. Possibilidades ilimitadas.</h2>
              <p className="text-slate-300 text-lg">Tudo o que sua empresa precisa para operar com excelência.</p>
            </div>
        ...
        <section className="py-24 bg-[#07070f]">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <h2 className="text-3xl font-bold tracking-tight mb-6 text-white">Segurança em primeiro lugar.</h2>
      ...
      {/* FOOTER */}
      <footer className="bg-[#020816] text-slate-300 py-16">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-sm text-slate-400">© 2026 OperaIQ. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
